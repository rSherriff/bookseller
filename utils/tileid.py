...
xp_file = gzip.open("utils/test.xp")
raw_data = xp_file.read()
xp_file.close()
data = load_xp_string(raw_data)
print(data['layer_data'][0]['cells'][0][0])
print(data['layer_data'][0]['cells'][1][0])
print(data['layer_data'][0]['cells'][2][0])
print(data['layer_data'][0]['cells'][3][0])
print(data['layer_data'][0]['cells'][4][0])
print(data['layer_data'][0]['cells'][5][0])
print(data['layer_data'][0]['cells'][6][0])
print(data['layer_data'][0]['cells'][7][0])
print(data['layer_data'][0]['cells'][8][0])
