...
class NotificationUI(UI):
    def __init__(self, section, x, y, b_x, b_y,b_width, b_height):
        ...
        close_button = Button(x=b_x, y=b_y, width=b_width, height=b_height, click_action=CloseNotificationDialog(self.section.engine, None),n_fg=notification_dialog_info["b_fg_color"],h_fg=notification_dialog_info["b_h_color"])
