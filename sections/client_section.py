...
class ClientSection(Section):
    def __init__(self, engine, x: int, y: int, width: int, height: int):
        ...
        self.dialog_tick_interval = 0.05
    ...
    def render(self, console):
        ...
        if self.animation_tick % 2 == 0:
            x = client_character_info["sprites"]["talk_one"]["x"]
            y = client_character_info["sprites"]["talk_one"]["y"]
        else:
            x = client_character_info["sprites"]["talk_two"]["x"]
            y = client_character_info["sprites"]["talk_two"]["y"]
